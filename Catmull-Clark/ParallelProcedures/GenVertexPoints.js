...
GenVertexPoints.prototype.InitBuffers =function (){
...
GenVertexPoints.prototype.GetNullResults =function(userData)
{
}
...
GenVertexPoints.prototype.GetResults = function (cl)
{  
  try {
    if(userData.isGLCLshared) {
